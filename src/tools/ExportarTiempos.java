...
public class ExportarTiempos {
    ...
    private static List<String> matrices = new ArrayList<>(Arrays.asList("matriz256x256", "matriz512x512", "matriz1024x1024", "matriz2048x2048", "matriz4096x4096", "matriz6144x6144", "matriz8192x8192", "matriz10240x10240"));
